...
export const metadata: Metadata = {
  ...
  description:
    `Nikmati layanan laundry premium ${siteConfig.name} dengan pickup & delivery gratis. Cuci reguler mulai Rp 5.000/kg, dry cleaning, express service dalam 24 jam. Garansi bersih 100%. Pesan sekarang!`,
  keywords: [
    "laundry jakarta",
  ...
  openGraph: {
    title:  `${siteConfig.name}`,
    description:
      `Nikmati layanan laundry premium ${siteConfig.name} dengan pickup & delivery gratis. Cuci reguler mulai Rp 5.000/kg, dry cleaning, express service dalam 24 jam. Garansi bersih 100%.`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "LaundryPro - Layanan Laundry Premium Jakarta",
      },
    ],
  },
  twitter: {
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-muted-foreground max-w-[600px]">
                    Nikmati layanan laundry premium dengan teknologi modern. Pickup gratis, cuci bersih, dan antar
                    kembali dalam 24 jam. Mudah, cepat, dan terpercaya!
                  </p>
                </div>
        ...
        <section id="layanan" className="py-20 md:py-32">
          <div className="@container px-4 md:px-6">
            <div className="text-center space-y-4 mb-16">
              ...
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Layanan Laundry Terlengkap</h2>
              <p className="text-xl text-muted-foreground max-w-[800px] mx-auto">
                Dari cuci reguler hingga dry cleaning premium, kami menyediakan semua kebutuhan laundry Anda
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Cuci bersih pakaian sehari-hari dengan deterjen berkualitas dan pewangi yang tahan lama.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Perawatan khusus untuk pakaian formal, jas, gaun, dan bahan-bahan yang memerlukan penanganan khusus.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Layanan kilat untuk kebutuhan mendesak. Selesai dalam 6 jam dengan kualitas terjamin.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Layanan antar jemput gratis di area Jabodetabek. Jadwalkan pickup sesuai waktu Anda.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section id="harga" className="py-20 md:py-32 bg-muted/50">
          <div className="@container px-4 md:px-6">
            <div className="text-center space-y-4 mb-16">
              ...
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Paket Laundry Pilihan</h2>
              <p className="text-xl text-muted-foreground max-w-[800px] mx-auto">
                Pilih paket yang sesuai dengan kebutuhan Anda. Semua paket sudah termasuk pickup & delivery gratis.
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
              <Card className="border-2">
                <CardHeader>
                  ...
                  <CardDescription>Cocok untuk kebutuhan sehari-hari</CardDescription>
                  <div className="mt-4">
              ...
              <Card className="border-2 border-primary relative">
                <Badge className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-primary">Terpopuler</Badge>
                <CardHeader>
                  <CardTitle>Paket Premium</CardTitle>
                  <CardDescription>Kualitas terbaik dengan layanan express</CardDescription>
                  <div className="mt-4">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm">Cuci + Kering + Setrika + Lipat</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
              ...
              <Card className="border-2">
                <CardHeader>
                  ...
                  <CardDescription>Layanan eksklusif untuk pakaian premium</CardDescription>
                  <div className="mt-4">
        ...
        <section id="testimoni" className="py-20 md:py-32">
          <div className="@container px-4 md:px-6">
            <div className="text-center space-y-4 mb-16">
              ...
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Dipercaya Ribuan Pelanggan</h2>
              <p className="text-xl text-muted-foreground max-w-[800px] mx-auto">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    "Pelayanan LaundryPro sangat memuaskan! Pakaian selalu bersih dan wangi. Pickup dan delivery tepat
                    waktu. Recommended banget!"
                  </p>
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    "Sebagai pekerja kantoran yang sibuk, LaundryPro sangat membantu. Aplikasinya mudah digunakan dan
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    "Harga terjangkau dengan kualitas premium. Dry cleaning untuk jas kantor hasilnya sempurna. Terima
                    kasih LaundryPro!"
                  </p>
                  <div className="flex items-center space-x-3">
                    <Image
        ...
        <section className="py-20 md:py-32 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20">
          <div className="@container px-4 md:px-6 text-center">
            <div className="space-y-8 max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Siap Mencoba LaundryPro?</h2>
              <p className="text-xl text-muted-foreground">
                Bergabunglah dengan ribuan pelanggan yang sudah merasakan kemudahan layanan laundry premium kami. Daftar
                sekarang dan dapatkan diskon 20% untuk pemesanan pertama!
              </p>
              ...
              <p className="text-sm text-muted-foreground">
                Gratis pickup & delivery • Garansi bersih 100% • Customer service 24/7
              </p>
            </div>
          </div>
        </section>
